...
- <img src="https://qrmint.dev/favicon.ico" height="14" /> [QRMint](https://github.com/softvoyagers/qrmint-api-mcp) - Generate styled QR codes with custom colors, sizes, and error correction levels from Claude, Cursor, and any MCP-compatible AI assistant. Free, no API key required.
