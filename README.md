...
- <img src="https://faktuj.pl/favicon.ico" height="14"/> [Faktuj](https://github.com/softvoyagers/fakturka-api-mcp) - Generate Polish VAT invoices (faktury VAT) from Claude, Cursor, and any MCP-compatible AI assistant. Free, no API key required.
