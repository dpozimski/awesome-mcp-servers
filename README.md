...
- 📄 [Faktuj](https://github.com/softvoyagers/fakturka-api-mcp) - Generate Polish VAT invoices (Faktury VAT) with full legal compliance from any MCP-compatible AI assistant. Supports buyer/seller data, line items, tax calculations, and PDF export. Free, no API key required.
