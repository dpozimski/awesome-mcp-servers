...
- <img src="https://linkshrink.dev/favicon.ico" height="14" /> [LinkShrink](https://github.com/softvoyagers/linkshrink-api-mcp) - Shorten URLs, retrieve analytics, and unshorten links from Claude, Cursor, and any MCP-compatible AI assistant. Free, no API key required.
